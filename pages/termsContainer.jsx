        ...
        <div style={{ marginTop: 100 }}>
          <div>
            <input
              type="checkbox"
              id="cb1"
              onChange={() => setDisable1(!disable1)}
              checked={!disable1}
            />
            <label htmlFor="cb1">이용약관 </label>
            <span
          ...
          <input
            type="checkbox"
            id="agree"
            onChange={() => setDisable2(!disable2)}
            checked={!disable2}
          />
          <label htmlFor="agree">개인정보 처리 방침</label>
          <span
            style={{ cursor: "pointer" }}
          ...
          <div>
            <input
              type="checkbox"
              id="cb2"
              onChange={() => setDisable3(!disable3)}
              checked={!disable3}
            />
            <label htmlFor="cb2">악의적 콘텐츠 제한 동의</label>
            <label className={styles.agreement}>
              <div>mentoridge는 건강하고 합법적인 콘텐츠를 지향합니다.</div>
              <p>
              ...
              <div>4.기타 mentoridge 운영에 방해가 되는 콘텐츠</div>
              <p>
                악의적 콘텐츠로 판단되는 콘텐츠가 발견되면 적극적인 신고를
                부탁드립니다.
              </p>
            </label>
          </div>
